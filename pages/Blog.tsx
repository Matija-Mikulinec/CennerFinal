...
import { 
  ...
  Clock, ArrowLeft, Send, Sparkles, AlertCircle, ShieldCheck
} from 'lucide-react';
import { MOCK_BLOG_POSTS, MOCK_BLOG_COMMENTS } from '../constants';
    ...
    <div className={`relative ${depth > 0 ? 'ml-4 md:ml-8 mt-4' : 'mt-8'}`}>
      ...
      <div className="flex space-x-3">
        <div className="flex flex-col items-center">
           <img src={comment.authorAvatar} alt="" className="w-8 h-8 rounded-full border border-white/10" />
...
const Blog: React.FC = () => {
  ...
  const sortedPosts = useMemo(() => {
    return [...MOCK_BLOG_POSTS].sort((a, b) => b.votes - a.votes);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-brand-black pt-12 pb-24">
      <div className="max-w-7xl mx-auto px-4 lg:px-12">
        ...
        {/* Header Section - The "Red Line" boundary is simulated by the margin and divider */}
        <div className="mb-6">
          {selectedPost ? (
          ...
          {/* Subtle boundary line (Red line from user drawing) */}
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-10 items-start">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
                  ...
                  <div className="flex">
                    ...
                    <div className="flex-grow p-6 md:p-10">
                      <div className="flex items-center space-x-3 mb-4">
                        <img src={selectedPost.authorAvatar} alt="" className="w-6 h-6 rounded-full border border-white/10" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between border-b border-white/5 pb-6">
                    <div className="flex items-center space-x-4 text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">
                       <span>Filter threads:</span>
                       <button className="flex items-center text-brand-green hover:text-white transition-colors">
                         <span>Best Responses</span>
                  ...
                  <div className="space-y-6">
                    {MOCK_BLOG_COMMENTS.map(comment => (
          ...
          {/* Sticky Sidebar Column - Starts below the red line and matches spacing */}
